...
--changeset SemyonIvakaev:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset SemyonIvakaev:create-identity-user_accounts-table
...
--changeset SemyonIvakaev:create-identity-user_roles-table
...
--changeset SemyonIvakaev:create-identity-user_accounts_roles-table
...
--changeset SemyonIvakaev:add-user_accounts_roles-table-constraints
